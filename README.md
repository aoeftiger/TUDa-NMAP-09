...
Nineth part of a jupyter notebook lecture series, lecture held on 23.12.2022.

Find the rendered HTML slides [here](https://aoeftiger.github.io/TUDa-NMAP-09/).
...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/aoeftiger/TUDa-NMAP-09/v1.01)
...
``` bash
wget https://github.com/aoeftiger/TUDa-NMAP-09/archive/refs/heads/main.zip
unzip main.zip
cd TUDa-NMAP-09-main
```
